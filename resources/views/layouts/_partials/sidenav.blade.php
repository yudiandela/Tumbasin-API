<nav class="nav flex-column">
    ...
    <a class="nav-link {{ strpos(Route::currentRouteName(), 'apikey') !== false ? 'border border-right-0 text-muted' : 'border-right'}}"
        href="{{ route('apikey.index') }}">
        <i class="mr-1 fas fa-key"></i> Api Key
    </a>
